...
const dataList: Profile[] = [
  {
    id: 1,
    name: 'Facebook',
    description:
      'Meta Platforms previously known as Facebook, Inc. is an American technology conglomerate based in Menlo Park, California. Facebook products include the Facebook social networking site, the Instagram photo-sharing platform, the WhatsApp messaging application, and the Oculus virtual reality headset.',
